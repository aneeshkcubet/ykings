                         ...
                         <tr>
                            <td align="center" style="padding:90px 20px 80px">
                              <table cellpadding="0" cellspacing="0" width="100%">
                                 ...
                                 <tr>
                                    <td align="center" style=" font:bold 24px Arial, sans-serif; color:#231f20; ">Welcome to Ykings PBT, <span style="color:#f6b220; display:inline-block; vertical-align:middle;
                                    padding-left:5px">{{$first_name}} {{$last_name}}</span></td>
                                 </tr>
                                  <tr>
                                    <td align="center" style=" padding:40px 16% 45px; color:#858283; font:normal 18px/30px Arial, sans-serif;">Thanks for Joining <span style="font-weight:bold; color:#231f20">Ykings PBT!</span> We really appreciate it.  We just need you to verify your email address before your 
                sign up is complete!  Please click the button below to verify your account:</td>
                                 </tr>
                                 <tr>
                                    <td align="center" valign="top" style="padding-bottom:52px">
                                      <table cellpadding="0" cellspacing="0">
                                         <tr>
                                           <td style="background-color:#f6b220; padding:10px 40px; text-align:center;"><a href="{{ asset('api/verify?token=' . $confirmation_code)}}" style="font:normal 18px/26px Arial,sans-serif; text-decoration:none; color:#ffffff;">Verify Email</a></td>
                                         </tr>
                                      </table>
                                    </td>
                                 </tr>
