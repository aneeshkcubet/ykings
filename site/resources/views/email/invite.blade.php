...
<html>
    <head>
        ...
        <title>Invitation to Ykings PBT!</title>
        <style>
                                                ...
                                                <tr>
                                                    <td align="center" style="padding:90px 20px 80px">
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="center" style=" font:bold 24px Arial, sans-serif; color:#231f20; ">Welcome to Ykings PBT, <span style="color:#f6b220; display:inline-block; vertical-align:middle;padding-left:5px">{{$userName}}</span></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" >
                                                                    You have got an invitation from <span style="font-weight:bold; color:#231f20">Ykings PBT!</span> referred by {{$first_name}} {{$last_name}}.
                                                                    Your referral code is <strong>{{$code}}</strong>.
                                                                    <br />
                                                                    <br />
                                                                    To visit <span style="font-weight:bold; color:#231f20">Ykings PBT!</span> on Google Play Store <a href="#">Click here</a>
                                                                    <br />
                                                                    <br />
                                                                    To visit <span style="font-weight:bold; color:#231f20">Ykings PBT!</span> on App Store <a href="#">Click here</a>
                                                                    <br />
                                                                    <br />
                                                            </tr>
                                                            <tr>
