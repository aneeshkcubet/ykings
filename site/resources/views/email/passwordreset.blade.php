<?php
$profile = Helper::getProfile($user->id);
?>
<!doctype html>
<html>
<head>
                         ...
                         <tr>
                            <td align="center" style="padding:90px 20px 80px">
                              <table cellpadding="0" cellspacing="0" width="100%">
                                 ...
                                 <tr>
                                    <td align="center" style=" font:bold 24px Arial, sans-serif; color:#231f20; ">Hi, <span style="color:#f6b220; display:inline-block; vertical-align:middle;
                                    padding-left:5px">@if(isset($profile->first_name) && $profile->first_name != ''){{$profile->first_name}} @endif @if(isset($profile->last_name) && $profile->last_name != ''){{$profile->last_name}} @endif</span></td>
                                 </tr>
                                  <tr>
                                    <td align="center" style=" padding:40px 16% 45px; color:#858283; font:normal 18px/30px Arial, sans-serif;"> We’ve recieved a request to reset your password. 
If you didn’t make the request, just ignore the email. Otherwise you can 
reset your password using the below button.</td>
                                 </tr>
                                 <tr>
                                    <td align="center" valign="top" style="padding-bottom:52px">
                                      <table cellpadding="0" cellspacing="0">
                                         <tr>
                                           <td style="background-color:#f6b220; padding:10px 15px; text-align:center;"><a href="{{ asset('password/reset/'.$token) }}" style="font:normal 18px/26px Arial,sans-serif; text-decoration:none; color:#ffffff;">Reset Password</a></td>
                                         </tr>
                                      </table>
                                    </td>
                                 </tr>
