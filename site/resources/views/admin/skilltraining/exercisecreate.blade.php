...
<section class="content-header">
    <h1>Create Skilltraining Exercise</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">Create Skilltraining Exercise</li>
    </ol>
</section>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> <i class="livicon" data-name="users" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                        Add exercise to {{{ $skilltraining->name }}}
                    </h3>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-wizard form-horizontal" action="{{ route('admin.skilltraining.skilltrainingexercise.postcreate', $skilltraining->id) }}" method="POST" id="wizard" enctype="multipart/form-data">
                                <!-- CSRF Token -->
