...
{{-- Page title --}}
@section('title')
View Fundumental - {{ $fundumental['exercise']->name }}
@parent
@stop
...
<section class="content-header">
    <h1>View Fundumental : {{ $fundumental['exercise']->name }}</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">{{ $fundumental['exercise']->name }}</li>
    </ol>
</section>
