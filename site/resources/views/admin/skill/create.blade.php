...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Add New Skill</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> <i class="livicon" data-name="skills" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                        Add New Skill
                    </h3>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <form class="form-wizard form-horizontal" action="{{ route('admin.skill.postcreate') }}" method="POST" id="wizard" enctype="multipart/form-data">
                                <!-- CSRF Token -->
                                ...
                                <section>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <select id="progression_id" name="progression_id" class="form-control required">
