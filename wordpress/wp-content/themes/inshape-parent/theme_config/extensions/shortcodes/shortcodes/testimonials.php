...
function tfuse_testimonials($atts, $content = null) {
    ...
    <div class="slider slider_quotes '.$t.'">
        ...
        <a class="prev" id="testimonials'.$testimonials_uniq.'_prev" href="#"><span class="tficon-chevron-left"></span></a>
        <a class="next" id="testimonials'.$testimonials_uniq.'_next" href="#"><span class="tficon-chevron-right"></span></a>
    </div> 
    <script>
