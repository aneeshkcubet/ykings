...
function tfuse_minigallery($attr, $content = null)
{
    ...
    <div class="minigallery_carousel">
        ...
        <a class="prev" id="minigallery'.$uniq.'_prev" href="#"><span class="tficon-chevron-left-alt"></span></a>
        <a class="next" id="minigallery'.$uniq.'_next" href="#"><span class="tficon-chevron-right-alt"></span></a>
    </div>';
    $out .= ' <script>
