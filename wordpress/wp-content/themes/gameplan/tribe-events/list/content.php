								...
								<div class="span<?php echo (!has_post_thumbnail() ? "12":"7") ?>">
									<div class="post-wrap">
										  ...
										  <?php } 
											...
											echo tribe_get_country( get_the_ID());?> <?php if (get_event_google_map_link ()!='') { echo '<a class="tribe-events-gmap" href="'.get_event_google_map_link ().'" title="Click to view a Google Map" target="_blank">+ Google Map</a>'; } ?></span>
