...
<div class="tribe-mini-calendar-event event-<?php echo $wp_query->current_post;?><?php echo $class;?>">
	<div class="list-date">
		<i class="icon-bookmark <?php echo (ot_get_option('font_awesome')=='4'?'fa fa-bookmark':''); ?>"><!-- --></i>
		<!--
		<span
	...
	<div class="list-info">
		<h2><a href="<?php echo tribe_get_event_link(); ?>"><?php echo $post->post_title; ?><?php if ( tribe_get_cost() ) { ?> (<?php echo tribe_get_cost( null, true ); ?>)<?php } ?></a></h2>
