	...
	if($the_query->have_posts()){		
		...
		while($the_query->have_posts()){ $the_query->the_post();
			$meta_html = ($showmetadata) ? '
				<div class="datetime"><span class="icon-calendar '.($font_awesome==4?'fa fa-calendar':'').'"></span>'.get_the_date().'</div>
				<div class="comment"><span class="icon-comment '.($font_awesome==4?'fa fa-comment':'').'"></span>'.get_comments_number().' '.__('Comments','cactusthemes').'</div>' : '';
			$html .= '
			<li>
				<div class="postleft">
		...
		$html .= '
			...
			<div class="slides-control">
				<div class="dotted"><!---->
				<div class="control-a">
					<a href="javascript:void(0)" id="posts-prev-'.$id.'" class="icon-sign-blank '.($font_awesome==4?'fa fa-square':'').'">
						<span class="icon-caret-left '.($font_awesome==4?'fa fa-caret-left':'').'"><!----></span>
					</a>
					<a href="javascript:void(0)" id="posts-next-'.$id.'" class="icon-sign-blank '.($font_awesome==4?'fa fa-square':'').'">
