...
class TF_Widget_Instagram extends WP_Widget {
    ...
    function TF_Widget_Instagram() {
        ...
        parent::__construct('Instagram', __('TFuse - Instagram','tfuse'), $widget_ops, $control_ops);
    }
    ...
    function widget( $args, $instance ) {
        ...
        <?php if ( ! empty( $instagram_photos ) && ! isset($instagram_photos->errors ) ) { ?>
                <ul class="instagram clearfix">
                    <?php foreach($instagram_photos as $image){ ?>
                        <li><a href="http://instagram.com/p/<?php echo $image['code']; ?>">
                ...
                <?php if($follow_button != ''){ ?>
                    <a href="http://instagram.com/<?php echo $instance['user']; ?>" class="btn btn-full"><span><?php echo tfuse_qtranslate($follow_button); ?></span></a>
                <?php } ?>
        <?php } ?>
    <?php
        echo $after_widget;
