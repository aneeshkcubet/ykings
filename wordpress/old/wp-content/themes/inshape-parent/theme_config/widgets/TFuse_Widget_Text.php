        ...
        <?php echo $before_title . $title . $after_title; } ?>
                ...
                <div class="social-links">
                    ...
                    <?php if(!empty($instance['adv'])):?>
                        <a href="<?php echo $instance['adv'];?>" title="<?php _e('Trip Advisor','tfuse');?>" target="_blank"><i class="tficon-trip"></i></a>
                    <?php endif;?>
...
?>
		...
		<input class="widefat" id="<?php echo $this->get_field_id('pin'); ?>" name="<?php echo $this->get_field_name('pin'); ?>" type="text" value="<?php echo esc_attr($pin); ?>" /></p>
                <p><label for="<?php echo $this->get_field_id('adv'); ?>"><?php _e('Trip Advisor Link:','tfuse'); ?></label>
