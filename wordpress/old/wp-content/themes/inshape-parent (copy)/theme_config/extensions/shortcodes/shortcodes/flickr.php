...
function tfuse_flickr($atts, $content)
{
    ...
    return $title . '<div class="widget widget_flickr clearfix"><script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=' . $items . '&amp;display=random&amp;size=s&amp;layout=x&amp;source=user&amp;user=' . $flickr_id . '"></script></div>';
}
