...
class TFuse_Widget_Text extends WP_Widget {
	...
	function widget( $args, $instance ) {
        ...
        <?php echo $before_title . $title . $after_title; } ?>
                ...
                <div class="social-links">
                    ...
                    <?php endif;?>
                    <?php if(!empty($instance['adv'])):?>
                        <a href="<?php echo $instance['adv'];?>" title="<?php _e('Trip Advisor','tfuse');?>" target="_blank"><i class="tficon-google"></i></a>
                    <?php endif;?>
                    ...
                    <?php endif;?>
                    <?php if(!empty($instance['you'])):?>
                        <a href="<?php echo $instance['you'];?>" title="<?php _e('Youtube','tfuse');?>" target="_blank"><i class="icon-youtube"></i></a>
                    <?php endif;?>
                </div>
                <?php endif;?>
		<?php
	...
	function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array( 'title' => '', 'text' => '','fb' => '','tw' => '','adv' => '','pin' => '','in' => '', 'you' => '' ,'nopadding' => '' ) );
...
?>
		...
		<input class="widefat" id="<?php echo $this->get_field_id('pin'); ?>" name="<?php echo $this->get_field_name('pin'); ?>" type="text" value="<?php echo esc_attr($pin); ?>" /></p>
                <p><label for="<?php echo $this->get_field_id('adv'); ?>"><?php _e('Google-Plus Link:','tfuse'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('adv'); ?>" name="<?php echo $this->get_field_name('adv'); ?>" type="text" value="<?php echo esc_attr($adv); ?>" /></p>
		...
		<input class="widefat" id="<?php echo $this->get_field_id('in'); ?>" name="<?php echo $this->get_field_name('in'); ?>" type="text" value="<?php echo esc_attr($in); ?>" /></p>
				<p><label for="<?php echo $this->get_field_id('you'); ?>"><?php _e('Youtube link:','tfuse'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('you'); ?>" name="<?php echo $this->get_field_name('you'); ?>" type="text" value="<?php echo esc_attr($you); ?>" /></p>
<?php
	}
}
