...
<html lang="en">
  ...
  <div class="newsletter-container clearfix" style="background: url('./images/Bg_newsletter1.jpg') no-repeat 0 0; background-size:cover;">
    <div class="logo"><img src="images/logo-ykings.png" alt=""></div>
     <div class="content-wrap">
        <div class="content-inner">
           <img src="images/slide.png" alt="" class="side-bg">
        ...
        <div class="content-footer">
            <img src="images/footer-side.png" class="footer-side" alt="">
            <p>
    ...
    $(document).ready(function() {
      function setHeight() {
        ...
        $('.newsletter-container, .content-wrap,.content-block').css('min-height', windowHeight + "px");
      };
      var footheight=$('.content-footer').height() + 70;    
     function setfootheight() {
         $('.content-block').css('min-height', windowHeight - footheight );
     };
      setHeight();
      setfootheight();    
