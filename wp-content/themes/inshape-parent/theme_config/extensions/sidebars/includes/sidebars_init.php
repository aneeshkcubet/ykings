...
function sidebar_workout ($post_types){
    unset($post_types['workout']);
    return $post_types;
}
add_filter('tfuse_sidebar_posts', 'sidebar_workout');
...
function sidebar_services ($taxonomies){
    unset($taxonomies['services']);
    return $taxonomies;
}
add_filter('tfuse_sidebar_services', 'sidebar_services');

function sidebar_nutrition ($taxonomies){
    unset($taxonomies['nutrition']);
    return $taxonomies;
}
add_filter('tfuse_sidebar_nutrition', 'sidebar_nutrition');

function sidebar_tags ($taxonomies){
    unset($taxonomies['tags']);
    return $taxonomies;
}
add_filter('tfuse_sidebar_tags', 'sidebar_tags');
