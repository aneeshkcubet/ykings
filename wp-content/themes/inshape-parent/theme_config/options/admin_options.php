            ...
            'headings' => array(
                ...
                array(
                    ...
                    'options' => array(/* 1 */
                        ...
                        array(
                            'name' => __('Subtitle Logo','tfuse'),
                            'desc' => __('Enter your subtitle for logo','tfuse'),
                            'id' => TF_THEME_PREFIX . '_logo_subtitle_text',
                      ...
                      // Sticky menu
                        array(
                            'name' => __('Enable Sticky Menu','tfuse'),
                            'desc' =>  __('Enable Sticky Menu?','tfuse'),
                            'id' => TF_THEME_PREFIX . '_sticky',
                            'value' => 'false',
                            'type' => 'checkbox',
                            'divider' => true
                        ),
            ...
            'headings' => array(
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => __('Sub Titles','tfuse'),
                            'desc' => __('Select the subtitles font. You can preview it on ','tfuse').'<a href="https://www.google.com/fonts" target="_blank">'.__(' Google Fonts','tfuse').'</a>',
                            'id' => TF_THEME_PREFIX . '_subtitles_font',
                            'value' => 'montstmerrat',
                            'options' => array(
                                'hand_writting' => '---Handwriting---',
                                'great_vibes' => 'Great Vibes',
                        ...
                        array('name' => __('Caps Text','tfuse'),
                            'desc' => __('Select Yes if you want your Sub Titles to be caps','tfuse'),
                            'id' => TF_THEME_PREFIX . '_caps_sub',
                            'value' => true,
                            'type' => 'checkbox'
                        )
                    )
                ...
                array(
                    ...
                    'options' => array(
                        array('name' => __('Primary Bg Color','tfuse'),
                            'desc' => __('Select Primary Background Color','tfuse'),
                            'id' => TF_THEME_PREFIX . '_bg_color',
                            'value' => '#fff',
                            'type' => 'colorpicker',
                            'divider' => true
                        ),
                        array('name' => __('Secondary Bg Color','tfuse'),
                            'desc' => __('Select Secondary Background Color','tfuse'),
                            'id' => TF_THEME_PREFIX . '_sec_bg_color',
                            'value' => '#ebeff0',
                            'type' => 'colorpicker',
                            'divider' => true
                        ),
                        array('name' => __('Menu Bg Color','tfuse'),
                            'desc' => __('Select Menu Background Color','tfuse'),
                         ...
                         array('name' => __('Highlight Color','tfuse'),
                            'desc' => __('This affects different elements across the website like links and subtitles','tfuse'),
                        ...
                        array('name' => __('Headings Color','tfuse'),
                            'desc' => __('Select Headings Color','tfuse'),
                        ...
                        array('name' => __('Menu Text Color','tfuse'),
                            'desc' => __('Select Menu Text Color','tfuse'),
            ...
            'headings' => array(
                ...
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => __('Enable Footer Menu','tfuse'),
                            'desc' => __('Enable Footer Menu','tfuse'),
                            'id' => TF_THEME_PREFIX . '_footer_menu',
                            'value' => true,
                            'type' => 'checkbox',
                            'divider' => true
                        ),
