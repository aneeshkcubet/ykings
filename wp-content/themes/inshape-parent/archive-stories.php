                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-desc invisible" data-animate-in="fadeInRight"><?php echo term_description( $term->term_id,'stories' );?></div>
                            <a href="#postlist-stories" class="btn btn-transparent invisible anchor" data-animate-in="fadeInUp"><span><?php _e('VIEW success stories','tfuse');?></span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="main-row main-row-slim">
    <div id="postlist-stories" class="postlist-stories">
        <div id="content_load">
            <?php if (have_posts()) 
             { $count = 0;
                 while (have_posts()) : the_post(); $count++;
                     get_template_part('listing', 'stories');
                 endwhile;
             } 
             else 
             { ?>
       ...
       <?php } ?>
        ...
        <?php if(tfuse_options('pagination_type') == 'type2'):?>
            <div class="row text-center stories">
